...
const responsive = {
  ...
  desktop: {
    ...
    slidesToSlide: categories.length,
  },
};
    ...
    className={`shrink-0 px-4 py-2 rounded-full text-sm font-semibold border transition
      ${
        active
          ...
          : "bg-transparent text-gray-700 border-transparent hover:border-amber-400 hover:bg-amber-400 hover:text-white"
      }`}
  >
    {label}
  </button>
    ...
    <>
      ...
      <div className="px-6 py-6 container mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <h2 className="text-black  md:text-[30px] font-extrabold whitespace-nowrap">
      ...
      <style jsx global>{`
        ...
        .react-multicarousel-arrow--left {
          left: -14px;
        }
        .react-multicarousel-arrow--right {
          right: -14px;
        }
      `}</style>
    </>
